...
const articles = [
  {
    ...
    authorRole: "Astróloga profesional (AFAN), 14 años de consulta",
    readingTimeMin: 6,
    published: true,
  ...
  },
  {
    ...
    authorRole: "Tarotista, formado en la tradición Rider-Waite-Smith",
    readingTimeMin: 5,
    published: true,
  ...
  },
  {
    ...
    sign: "Aries",
    authorName: "Tomás Reyes",
    authorRole: "Tarotista y estudiante de astrología clásica",
    readingTimeMin: 5,
    published: true,
